...
export default class XVideo extends Component {
  ...
  render () {
    return (
      <View className='Videos'>
        <Banner type='v'  mySetState={this.mySetState} scrollHeight={this.state.scrollHeight} types={this.state.types} activeTypeIndex={this.state.activeTypeIndex} ></Banner>
